...
@Component({
  ...
  template: `
    <ng-template tdLoading="name"> <div class="content"></div> </ng-template>
  `,
})
...
@Component({
  ...
  template: `
    <ng-template tdLoading="name1"> <div class="content"></div> </ng-template>
    <ng-template tdLoading="name1"> <div class="content"></div> </ng-template>
  `,
})
...
@Component({
  ...
  template: `
    <ng-template tdLoading [tdLoadingUntil]="!loading"> <div class="content"></div> </ng-template>
  `,
})
